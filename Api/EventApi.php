...
class EventApi extends \Zikula_AbstractApi
{
    ...
    public function getEvents($args)
    {
        ...
        $events = $this->entityManager->getRepository('\Zikula\PostCalendar\Event\CalendarEventEntity')
    ...
    public function writeEvent($args)
    {
        ...
        if ($eventdata['is_update']) {
            ...
            $event = $this->entityManager->getRepository('\Zikula\PostCalendar\Event\CalendarEventEntity')->find($eventdata['eid']);
        } else { //new event
    ...
    public function buildSubmitForm($args)
    {
        ...
        $eventdata['hasexceptions'] = ((isset($eventdata['recurrspec']['exceptions'])) && (count($eventdata['recurrspec']['exceptions']) > 0));
