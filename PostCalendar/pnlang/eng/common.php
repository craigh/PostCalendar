...
define('_CALJUL', 'July');
define('_CALJUN', 'June');
define('_CAL_LISTVIEW', 'List View');
...
define('_PC_ADMIN_CATEGORY_SETTINGS', 'PostCalendar Category Settings');
...
define('_PC_ADMIN_GLOBAL_SETTINGS', 'PostCalendar Global Settings');
...
define('_PC_BLOCK_NO_EVENTS', 'No Events Today');
...
define('_PC_LIST_HOW_MANY', 'Number of events to list on admin pages');
...
define('_PC_NOTIFY_ADMIN', 'Notify Admin About <b>USER</b> Event Submission/Modification');
define('_PC_NOTIFY_ADMIN2ADMIN', 'Notify Admin About <b>ADMIN</b> Event Submission/Modification');
...
define('_PC_SEARCH_NORESULTS', 'PostCalendar: No Results:');
define('_PC_ANY_CATEGORY', 'Any Category');
define('_PC_ANY_TOPIC', 'Any Topic');
define('_PC_ICALDOWN','Download .ics (iCal) file');
define('_PC_ICALUP','Upload .ics (iCal) file');
...
define('_PC_FILEUPLOAD', 'Upload .ics (iCal) File');
define('_PC_FILETOUPLOAD', 'File to upload:');
define('_CALMONTHLISTVIEW', 'Month List View');
define('_CALEVENTPREVIEW', 'Event Preview');
define('_PC_ADDCALENDAREVENT', 'Add New Calendar Event');
define('_CALSELECT', 'Select');
define('_CALTIMESTAMP', 'Timestamp (entered on)');
