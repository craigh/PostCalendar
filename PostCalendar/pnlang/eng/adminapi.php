...
define('_POSTCALENDAR_MAILGREET_NOTIFICATION', 'PostCalendar Meeting Notification');
...
define('_POSTCALENDAR_MAILFOOT',               'This event and further details can be viewed under');
define('_POSTCALENDAR_MEETINGEMAILSENT',       'Meeting notify email sent');
define('_POSTCALENDAR_MEETINGEMAILNOT',        'Meeting notify email not sent');
define('_POSTCALENDAR_NOTIFYEMAILSENT',        'Admin notify email sent');
define('_POSTCALENDAR_NOTIFYEMAILNOT',         'Admin notify email not sent');
