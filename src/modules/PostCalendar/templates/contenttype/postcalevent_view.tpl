...
<h2 class="eventheader">
    ...
    <a href="{modurl modname='PostCalendar' type='user' func='display' viewtype='event' eid=$loaded_event.eid}" title='{gt text='Full event information' domain="module_postcalendar"}'>
