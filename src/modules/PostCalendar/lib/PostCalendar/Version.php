...
class PostCalendar_Version extends Zikula_Version
{
    ...
    protected function setupHookBundles()
    {
        ...
        $bundle->addHook('hookhandler.postcalendar.config.ui.edit', 'config.ui.edit', 'PostCalendar_HookHandlers', 'config_ui_edit', 'postcalendar.service', 10);
        $bundle->addHook('hookhandler.postcalendar.config.process.edit', 'config.process.edit', 'PostCalendar_HookHandlers', 'config_process_edit', 'postcalendar.service', 10);
